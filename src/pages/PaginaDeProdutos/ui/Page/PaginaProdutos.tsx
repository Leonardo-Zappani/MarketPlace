...
const PaginaProdutos: FC = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 my-32">
      ...
      return (
        <div onClick={() => navegar('/produto/' + produto.id)}  key={produto.id} className="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
          <a className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
            <img onclick={() => navegar('/produto/' + produto.id)} className="object-cover" src={produto.image} alt={produto.title} />
          ...
          <div className="mt-4 px-5 pb-5">
            ...
            <button onClick={() => addToCart(produto)} className="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
